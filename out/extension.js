 ...
 */
function hasCodeAfter(document, position) {
 ...
 */
async function removeAllConsoleLogs(editor) {
    // 获取文档的所有内容
 ...
 */
function isMethodParameter(document, selection) {
 ...
 * @returns {string} 缩进字符串
 */
function getAppropriateIndentation(document, selection) {
...
function getConfiguredStyle() {
    ...
    const borderRadius = config.get('borderRadius');
